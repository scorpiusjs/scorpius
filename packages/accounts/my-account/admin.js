...
scorpius.accounts.addProtectedRoute('myAccount.index');
...
scorpius.accounts.addProtectedRoute('myAccount.password');
...
scorpius.accounts.addProtectedRoute('myAccount.profile');
...
if (Meteor.isClient) {
  ...
  ReactiveTemplates.helpers('myAccount.profile', {
    ...
    getSchema: function() {
      return scorpius.accounts.profileSchema;
    }
  });
}
