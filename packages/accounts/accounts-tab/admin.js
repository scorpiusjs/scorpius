...
scorpius.accounts.addProtectedRoute('accounts.index');
...
var tabularOptions = {
  ...
  columns: [
    {
      data: 'profile.name',
      title: scorpius.helpers.getTranslation('accounts.index.tableTitles.name'),
    ...
    {
      data: 'usedServices',
      title: scorpius.helpers.getTranslation('accounts.index.tableTitles.services'),
      render: function(val, type, doc) {
    ...
    {
      data: 'emails',
      title: scorpius.helpers.getTranslation('accounts.index.tableTitles.email'),
      render: function(val, type, doc) {
    ...
    {
      data: 'roles',
      title: scorpius.helpers.getTranslation('accounts.index.tableTitles.roles'),
      render: function(val, type, doc) {
    ...
    {
      title: scorpius.helpers.getTranslation('accounts.index.tableTitles.actions'),
      render: function(val, type, doc) {
        return _.filter(scorpius.accounts._adminUsersButtons, function(value, key, list){
...
Tracker.autorun(function () {
  ...
  scorpius.accounts.indexTabularTable = new Tabular.Table(tabularOptions);
});
...
scorpius.accounts.addProtectedRoute('accounts.update');

if (Meteor.isClient) {
  Tracker.autorun(function () {
    scorpius.accounts.addAdminUsersButton({
