...
scorpius.accounts.addProtectedRoute('pages.index');
...
scorpius.accounts.addProtectedRoute('pages.create');
...
scorpius.accounts.addProtectedRoute('pages.update');
...
scorpius.accounts.addProtectedRoute('pages.delete');
