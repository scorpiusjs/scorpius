scorpius.collections.onCreated(function() {
  var self = this;
   ...
   */
  scorpius.accounts.addProtectedRoute('collections.' + self.name + '.index');
   ...
   * Ensure user is logged in
   */
  scorpius.accounts.addProtectedRoute('collections.' + self.name + '.create');
   ...
   * Ensure user is logged in
   */
  scorpius.accounts.addProtectedRoute('collections.' + self.name + '.update');
   ...
   * Ensure user is logged in
   */
  scorpius.accounts.addProtectedRoute('collections.' + self.name + '.delete');
});
